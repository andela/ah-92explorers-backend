...
const emailTemplates = {
  resetPassword: {
    ...
    <p><a style="background-color: #3097d1; border: 2px solid #3097d1; padding: 8px; color: #fff; font-size: 16px; text-decoration: none;cursor: pointer;" href="${clientUrl}/reset-password/$token">Reset Password</a>
    </a></p>
